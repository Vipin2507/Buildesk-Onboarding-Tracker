...
function serializeCompanyForApi(company: Company) {
  return {
    ...
    planName: company.planName || undefined,
    amountWithGst: cleanOptionalNumber(company.amountWithGst),
    taxableAmount: cleanOptionalNumber(company.taxableAmount),
    gstAmount: cleanOptionalNumber(company.gstAmount),
    paymentStatus: company.paymentStatus || undefined,
    commercialStatus: company.commercialStatus || undefined,
    installmentCount: cleanOptionalNumber(company.installmentCount),
    installmentAmount: cleanOptionalNumber(company.installmentAmount),
    installmentDueDate: company.installmentDueDate?.trim() || undefined,
    cancelledOn: company.cancelledOn?.trim() || undefined,
