...
export const companies = sqliteTable("companies", {
  ...
  state: text("state"),
  supportManager1Id: text("support_manager_1_id"),
  supportManager2Id: text("support_manager_2_id"),
  additionalSupportContactIdsJson: text("additional_support_contact_ids_json"),
