...
export const seedUsers: User[] = [
  ...
  },
  {
    id: "crm-user-1",
    name: "Ananya Mehta",
    email: "ananya@crm.buildesk.com",
    role: "Admin",
    productScope: "crm",
    active: true,
    phone: "+91 99000 11111",
    jobTitle: "CRM Implementation Head",
    department: "CRM",
    timezone: "Asia/Kolkata",
    notifyEmail: true,
    notifyInApp: true,
  ...
  },
  {
    id: "crm-user-2",
    name: "Vikram Shah",
    email: "vikram@crm.buildesk.com",
    role: "Manager",
    productScope: "crm",
    active: true,
    phone: "+91 99000 22222",
    jobTitle: "CRM Onboarding Manager",
    department: "CRM",
    timezone: "Asia/Kolkata",
    notifyEmail: true,
    notifyInApp: true,
...
export const seedCredentials: Record<string, string> = {
  ...
  "user-3": "buildesk123",
  "user-4": "buildesk123",
  "crm-user-1": "buildesk123",
  "crm-user-2": "buildesk123",
};
