...
export function CompanyTicketsPanel({ companyId }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h3 className="font-semibold">Company tickets</h3>
          <p className="mt-1 text-sm text-muted-foreground">
            {openCount} open · {companyTickets.length} total across all projects
          </p>
        </div>
      ...
      {companyTickets.length === 0 ? (
        <EmptyState
          title="No tickets for this company"
          description="Raise bugs, customizations, or requirements for any project under this company."
        ...
        <div className="grid gap-3">
          ...
          <div className="space-y-1.5">
            ...
            <DatePickerField
              ...
              onChange={(value) =>
                form.setValue("eta", value, { shouldDirty: true, shouldValidate: true })
              }
